...
public static partial class SymbolExtensions
{
    ...
    public static bool HasAnyAttributeInSelf(this ISymbol symbol, params IReadOnlyCollection<string> attributeNames) =>
    ...
    public static bool TryGetAnyAttributeInSelf(this ISymbol symbol, out AttributeData? outAttribute, params IReadOnlyCollection<string> attributeNames)
    {
    ...
    public static IEnumerable<AttributeData> GetAttributesInSelf(this ISymbol symbol, params IReadOnlyCollection<string> attributeNames)
    {
