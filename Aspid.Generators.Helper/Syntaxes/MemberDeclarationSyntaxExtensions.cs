...
{
    public static bool HasAttributeInSelf(this MemberDeclarationSyntax declaration, SemanticModel semanticModel, TypeText attributeName) =>
        TryGetAttributeInSelf(declaration, semanticModel, out _, attributeName);
    
    public static bool HasAnyAttributeInSelf(this MemberDeclarationSyntax declaration, SemanticModel semanticModel, params IReadOnlyCollection<string> attributeNames) =>
    ...
    public static bool TryGetAnyAttributeInSelf(this MemberDeclarationSyntax declaration, SemanticModel semanticModel, out IMethodSymbol? outAttribute, params IReadOnlyCollection<string> attributeNames)
    {
    ...
    public static IEnumerable<IMethodSymbol> GetAttributesInSelf(this MemberDeclarationSyntax declaration, SemanticModel semanticModel, params IReadOnlyCollection<string> attributeNames)
    {
